            ...
            <div className="d-flex">
              <div className="form-check mx-3 p-0">
                ...
                <label
                  ...
                  htmlFor="writtenWorkInstructionsAvaibleInStation1"
                >
                  Yes
                </label>
              </div>
              ...
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="writtenWorkInstructionsAvaibleInStation2"
                >
                  No
                </label>
              </div>
          ...
          <div className="col-md-12 d-flex">
            ...
            <div className="d-flex">
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="finalInspectionEvidence1"
                >
                  Yes
                </label>
              </div>
              ...
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="finalInspectionEvidence2"
                >
                  No
                </label>
              </div>
          ...
          <div className="col-md-12 d-flex">
            ...
            <div className="d-flex">
              ...
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="includeMethod2"
                >
                  No
                </label>
              </div>
              {errors.includeMethod && (
                <div style={{ color: "red" }}>{errors.includeMethod}</div>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="col-md-12 d-flex">
            ...
            <div className="d-flex">
              ...
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="qualityCapabilities2"
                >
                  No
                </label>
              </div>
              {errors.qualityCapabilities && (
                <div style={{ color: "red" }}>{errors.qualityCapabilities}</div>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="col-md-12 d-flex">
            ...
            <div className="d-flex">
              ...
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="approvedSupplierList2"
                >
                  No
                </label>
              </div>
              {errors.approvedSupplierList && (
                <div style={{ color: "red" }}>
                  {errors.approvedSupplierList}
                </div>
              )}
        ...
        <div className="row">
          <div className="col-md-12 d-flex">
            ...
            <div className="d-flex">
              ...
              {errors.marketPrice && (
                <div style={{ color: "red" }}>{errors.marketPrice}</div>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="col-md-12 d-flex">
            ...
            <div className="d-flex">
              ...
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="certifiedTestReports2"
                >
                  No
                </label>
              </div>
              {errors.certifiedTestReports && (
                <div style={{ color: "red" }}>
                  {errors.certifiedTestReports}
                </div>
              )}
          ...
          <div className="col-md-12 d-flex">
            ...
            <div className="d-flex">
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="supplierOnTimeDelivery1"
                >
                  Yes
                </label>
              </div>
              ...
              <div className="form-check mx-3 p-0">
                ...
                <label
                  className="form-check-label pt-1"
                  htmlFor="supplierOnTimeDelivery2"
                >
                  No
                </label>
              </div>
              {errors.supplierOnTimeDelivery && (
                <div style={{ color: "red" }}>
                  {errors.supplierOnTimeDelivery}
                </div>
              )}
