    ...
    <div className="flex-shrink-0 p-3" style={{ width: '220px', position: 'fixed', zIndex: 1050, height : '100vh', backgroundColor : '#6c8dfa', color : 'white'}}>
      ...
      <li className="mb-4">
          ...
          <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small p-3">
              ...
              <li className='mb-2'><a href="ViewProduct" className="rounded mb-4 text-dark">View Product</a></li>
              <li className='mb-2'><a href="EditProduct" className="rounded mb-4 text-dark">Edit Product</a></li>
            </ul>
          </div>
      </li>

      <li className="mb-4">
          <a className="mx-2 mb-2 btn-toggle align-items-center rounded collapsed text-white mb-3 font-weight-bold text-decoration-none" data-bs-toggle="collapse" data-bs-target="#materialManagement-collapse" aria-expanded="false"> Material Management </a>
