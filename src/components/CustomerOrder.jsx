...
const CustomerOrder = () => {
  ...
  const validateForm = () => {
    ...
    if (!/^[a-zA-Z0-9 ]{1,50}$/.test(partNo))
      newErrors.partNo = "Part No must be alphanumeric (max 50 characters)";
  ...
  const handleSubmitAll = async () => {
    ...
    try {
      ...
      alert(
        `${purchaseRequisitions.length} Customer Order List ready to be submitted!`
      );
    ...
    <div className="wrapper">
      ...
      <div className="content">
        ...
        <div style={{ marginTop: "10px" }}>
          <CustomBreadcrumb
            breadcrumbsLabel="Add Customer Order"
            isBack={true}
          />
                  ...
                  <form onSubmit={handleSubmit} style={{ height: "100%" }}>
                    <div className="col-md-12 p-3 d-flex">
                      <div className="col-md-6 p-2 d-flex">
                        <label className="col-md-4 mt-2">Sr. No. *</label>
                        <input
                        ...
                        />
                        {error.srNo && (
                          <span className="text-danger">{error.srNo}</span>
                        )}
                      </div>
                      <div className="col-md-6 p-2 d-flex">
                        <label className="col-md-4 mt-2">Batch Number *</label>
                        <input
                          className="form-control w-100"
                          type="text"
                          id="batchNo"
                    ...
                    <div className="col-md-12 p-2 d-flex">
                      <div className="col-md-6 p-2 d-flex">
                        ...
                        />
                        {error.roNo && (
                          <span className="text-danger">{error.roNo}</span>
                        )}
                      </div>
                      ...
                      <div className="col-md-6 p-1 d-flex">
                        ...
                        <input
                          ...
                          value={roReceiveDate}
                          onChange={(e) =>
                            handleInputChange(e, setRoReceiveDate)
                          }
                          required
                        />
                        {error.roReceiveDate && (
                    ...
                    <div className="col-md-12 d-flex">
                      ...
                      <div className="col-md-6 p-1 d-flex">
                        ...
                        />
                        {error.partNo && (
                          <span className="text-danger">{error.partNo}</span>
                        )}
                      </div>
                    </div>
                ...
                <div className="row mx-1 card border border-dark shadow-lg py-2 mt-4">
                  <div className="col-md-12">
                    ...
                    <div className="col-md-6 p-1 d-flex">
                      ...
                      {document && (
                        <div className="mt-1">
                          <small>Uploaded: {document.name}</small>
                        </div>
                      )}
                    </div>
                    <button
