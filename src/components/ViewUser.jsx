...
const ViewUser = () => {
  ...
  const columns = [
    ...
    { field: "firstName", label: "First Name", width: "150px" },
    { field: "middleName", label: "Middle Name", width: "150px" },
    { field: "lastName", label: "Last Name", width: "150px" },
    { field: "username", label: "Username", width: "120px" },
    { field: "dateOfBirth", label: "Date of Birth", width: "120px" },
    { field: "mobileNumber", label: "Mobile", width: "130px" },
    { field: "email", label: "Email", width: "180px" },
    { field: "address", label: "Address", width: "200px" },
    { field: "city", label: "City", width: "120px" },
    { field: "state", label: "State", width: "120px" },
    { field: "country", label: "Country", width: "120px" }
  ];
        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.breadcrumbSection}>
            <div className={styles.breadcrumbContent}>
              ...
              <span className={styles.breadcrumbLabel}>View Users</span>
            </div>
          </div>
