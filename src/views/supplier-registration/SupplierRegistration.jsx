            ...
            <div className="card border border-dark shadow mx-4 my-2 p-2" style={{height : '540px'}}>
              <div className="col-md-12">
                <ul className="nav nav-tabs" id="myTabs" role="tablist">
                    ...
                    <li className="nav-item" role="presentation">
                        <a className="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profileTab" role="tab" aria-controls="profileTab" aria-selected="false">Quality Analysis</a>
                    </li>
                    <li className="nav-item" role="presentation">
                ...
                <div className="tab-content mt-0 border" id="myTabsContent" style={{height : '445px'}}>
                    ...
                    <div className="tab-pane fade" id="profileTab" role="tabpanel" aria-labelledby="profile-tab">          <SupplierAnalysisTab    dataMap= {dataMap} handleChange={handleChange} validateDataType = {validateDataType} validateLen = {validateLen}/></div>
